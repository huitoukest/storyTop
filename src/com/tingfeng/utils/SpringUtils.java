...
public class SpringUtils {
	 ...
	 */
		public static void sendText(HttpServletResponse response, String s,String ContentType, String Header, String cache,String charEncoding) throws IOException {
			if (StringUtils_wg.isStringUsed(charEncoding))
				response.setCharacterEncoding(charEncoding);
			if (StringUtils_wg.isStringUsed(ContentType))
				response.setContentType(ContentType);
			if (StringUtils_wg.isStringUsed(Header) && StringUtils_wg.isStringUsed(cache))
